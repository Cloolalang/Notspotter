...
class MonitoringSettingsRepository(context: Context) {
    ...
    fun load(): MonitoringSettings {
        return MonitoringSettings(
            ...
            passiveSoundSpeed = prefs.getInt(
                KEY_PASSIVE_SOUND_SPEED,
    ...
    fun save(settings: MonitoringSettings) {
        ...
        prefs.edit()
            ...
            .putInt(KEY_PASSIVE_SOUND_SPEED, normalized.passiveSoundSpeed)
            .apply()
    }
    ...
    companion object {
        ...
        private const val KEY_PASSIVE_SOUND_SPEED = "passive_sound_speed"
    }
}
